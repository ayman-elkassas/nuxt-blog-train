            ...
            <div class="mt-5">
              <div class="timeline">
                <div v-for="post in $store.state.posts" :key="post.id" >
                  <div v-if="invertedFlag" class="timeline-wrapper timeline-wrapper-success">
                    <div class="timeline-badge"></div>
                    <div class="timeline-panel">
                      <div class="timeline-heading">
                        <nuxt-link :to="`/blog/${post.id}`">
                          <h6 @click="updateSelectedPost(post)" class="timeline-title">
                            {{post.title}}
                          </h6>
                        </nuxt-link>
                      </div>
                    ...
                    <span hidden>{{invertedFlag=false}}</span>
                  </div>
                  <div v-else class="timeline-wrapper timeline-inverted timeline-wrapper-success">
                    <div class="timeline-badge"></div>
                    <div class="timeline-panel">
                      <div class="timeline-heading">
                        <nuxt-link :to="`/blog/${post.id}`"><h6 class="timeline-title">{{post.title}}</h6></nuxt-link>
                      </div>
                      <div class="timeline-body">
                        <p>{{post.body}}</p>
                      </div>
                    ...
                    <span hidden>{{invertedFlag=true}}</span>
                  </div>
